...
CREATE TABLE CATEGORIE (
   ...
   CONSTRAINT CK_CATEGORIENAAM CHECK (LEN(CATEGORIENAAM) >=3)
)
...
CREATE TABLE GEBRUIKER (
   ...
   RECHTEN		  INT	NOT NULL DEFAULT (1),
...
CREATE TABLE PRODUCT (
   ...
   PRIJS            NUMERIC(20,2)      NOT NULL,
   VOORRAAD         INTEGER           NULL,
   INHOUD INT NULL,
   afbeelding VARCHAR(1024) NULL
   ...
   CONSTRAINT CK_OMSCHRIJVING   CHECK(LEN(OMSCHRIJVING) > 10),
